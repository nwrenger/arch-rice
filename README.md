...
Install arch via `archinstall`. It is important that you select these options: `btrfs`, `hyprland` and `sddm`. Also you need to install fish before running the install script via: `sudo pacman -Syu fish`.
